...
- **当前基线(PR #1)** —— handoff `8Q3zKqB6xqQ5Dd1YH2VXgg`(chat6 去 About)的原型快照存在 `8Q3zKqB6xqQ5Dd1YH2VXgg/`(`index.html` / `app.jsx` / `i18n.jsx` / `sections.jsx` / `sections2.jsx` / `landing.css`)。下次拿到新 handoff 时,以它为「上次设计」一方做三路 diff,合并后把快照换成新 handoff 的。
